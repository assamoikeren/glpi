...
class CheckPhotos extends StatefulWidget {
  static const routeName = '/checkphotos';
  @override
  _CheckPhotosState createState() => _CheckPhotosState();
}

class _CheckPhotosState extends State<CheckPhotos> {
